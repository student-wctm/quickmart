    ...
    <footer className="bg-gray-900 text-gray-300 mt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* About Section */}
          <div>
            <h3 className="text-white text-lg font-bold mb-4">About QuickMart</h3>
            <p className="text-sm mb-4">
              QuickMart is your trusted neighborhood grocery partner, bringing fresh essentials, daily staples, and household needs right to your doorstep.
            </p>
          ...
          {/* Categories */}
          <div>
            <h3 className="text-white text-lg font-bold mb-4">Shop by Category</h3>
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-primary transition">Vegetables & Fruits</a></li>
              <li><a href="#" className="hover:text-primary transition">Dairy & Breakfast</a></li>
              <li><a href="#" className="hover:text-primary transition">Snacks & Munchies</a></li>
              <li><a href="#" className="hover:text-primary transition">Cold Drinks & Juices</a></li>
              <li><a href="#" className="hover:text-primary transition">Instant & Frozen Food</a></li>
              <li><a href="#" className="hover:text-primary transition">Personal Care</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-3">
                ...
                <span>12, MG Road, Gandhi Nagar, Bangalore - 560001</span>
              </li>
              <li className="flex items-center space-x-3">
                <FiPhone className="text-primary flex-shrink-0" />
                <span>+91 85438 38313</span>
              </li>
              <li className="flex items-center space-x-3">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-6">
              ...
              <div className="bg-white p-2 rounded flex items-center justify-center">
                <span className="text-xs font-bold text-red-600">GPay</span>
              </div>
            </div>
            <div className="text-xs text-gray-400">
              <p className="mb-1">🔒 100% Secure Payments</p>
